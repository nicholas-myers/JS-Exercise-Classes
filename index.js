...
*/
class Lambdasian {
  constructor(lambdalorian) {
    this.name = lambdalorian.name;
    this.age = lambdalorian.age;
    this.location = lambdalorian.location;
  } //closes initializers
...
class Student extends Lambdasian {
  ...
  sprintChallenge(challenge) {
    return `${this.name} has begun sprint challenge for ${challenge}`;
  }
}
